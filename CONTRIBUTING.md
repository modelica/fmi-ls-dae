...
This ensures that all IP contributed to the FMI standard or Layered Standards will be licensed to the Modelica Association (MA) which in turn will sublicense to tool vendors implementing it and end users using it, free of charge.
