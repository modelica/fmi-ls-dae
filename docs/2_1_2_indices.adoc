...
<<cellier2006continuous,[cellier2006continuous, chapter 7.7 Structural Singularity Elimination]>> provides a simple electric circuit model that is an higher-index DAE.
