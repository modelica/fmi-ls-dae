...
state variables equation latexmath:[v_2 = v_1]
...
footnote:[e.g. by using Pantelides algorithm, see <<cellier1993automated>>]
to end up with a consistent initialization for the system.
