...
A differential-algebraic system of equations (DAE) is a system of equations that either contains differential equations and algebraic equations, or is equivalent to such a system footnote:[Source: https://en.wikipedia.org/wiki/Differential-algebraic_system_of_equations].
